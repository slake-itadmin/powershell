...
$user_email = "edmundchiu@silverglobe.com"
$slakeacc1 = Get-ADDomainController -DomainName slakeacc1.sssb.com -Discover -NextClosestSite

$result = Get-ADuser -Filter { EmailAddress -eq $user_email } -Properties * | Select DisplayName, SamAccountName, 
UserWorkstations, Enabled, LockedOut, PasswordExpired, PasswordLastSet, LastLogonDate, LastBadPasswordAttempt
$result
